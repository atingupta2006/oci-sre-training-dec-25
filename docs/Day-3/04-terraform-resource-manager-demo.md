...
This is an instructor-led demonstration. Students observe infrastructure provisioning automation.

**Note:** This demonstration builds on the Day 1 demonstration of Terraform with OCI Resource Manager. This session focuses more deeply on automation aspects and toil reduction.
...
* Understand Infrastructure as Code automation benefits
* See how Terraform automates infrastructure provisioning
* Recognize automation as a key toil reduction mechanism
* Be prepared for hands-on automation labs
